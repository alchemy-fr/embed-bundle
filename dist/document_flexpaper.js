...
with(obj||{}){
__p+='<div id="embed-document" class="embed-resource"></div>';
}
return __p;
};
 ...
 */
// require('html5shiv');
var swfobject = __webpack_require__(100);
var service_1 = __webpack_require__(5);
var playerTemplate = __webpack_require__(101);
var DocumentPlayer = function () {
    function DocumentPlayer() {
        ...
        var url = this.configService.get('resource.url');
        var scheme = window.location.protocol;
        if (url.substring(0, scheme.length) === 'http:') {} else if (url.substring(0, scheme.length) === 'https:') {} else {
            // fallback on current scheme:
            url = window.location.protocol + url;
        }
        var player = swfobject.embedSWF('/assets/vendors/alchemy-embed-medias/players/flexpaper/FlexPaperViewer.swf', this.documentEmbedContainerId, '100%', '100%', '9.0.0', false, false, {
            menu: 'false',
